...
bool litehtml::element::on_mouse_over(int x, int y, int client_x, int client_y)												LITEHTML_RETURN_FUNC(false)
bool litehtml::element::on_mouse_leave()											LITEHTML_RETURN_FUNC(false)
bool litehtml::element::on_lbutton_down(int x, int y, int client_x, int client_y)											LITEHTML_RETURN_FUNC(false)
bool litehtml::element::on_lbutton_up(int x, int y, int client_x, int client_y)												LITEHTML_RETURN_FUNC(false)
